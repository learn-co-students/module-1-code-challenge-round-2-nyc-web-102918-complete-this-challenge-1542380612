...
#`Viewer#rate_movie(movie, rating)`
 ...
 #   assign the rating to the viewer's `QueueItem` for that movie. If the movie is
 #   not already in the viewer's queue, this method should add a new `QueueItem` with
 #   the viewer, movie, and rating. If the movie is already in the queue, this method
